		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5solvac-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5solvac-display": {
								"semanticObject": "polarzui5solvac",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5solvac",
									"url": sap.ui.require.toUrl("polar/zui5solvac")
								}
							}
						}
					}
