		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Carta de certificación de ingresos y retenciones",
									"targetURL": "#polarzui5certingret-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5certingret-display": {
								"semanticObject": "polarzui5certingret",
								"action": "display",
								"description": "Carta de certificación de ingresos y retenciones",
								"title": "Carta de certificación de ingresos y retenciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5certingret",
									"url": sap.ui.require.toUrl("polar/zui5certingret")
								}
							}
						}
					}
