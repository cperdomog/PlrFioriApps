		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cesantía",
									"targetURL": "#polarzui5cesantia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5cesantia-display": {
								"semanticObject": "polarzui5cesantia",
								"action": "display",
								"description": "Cesantía",
								"title": "Cesantía",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5cesantia",
									"url": sap.ui.require.toUrl("polar/zui5cesantia")
								}
							}
						}
					}
