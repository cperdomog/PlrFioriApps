		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5statement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5statement-display": {
								"semanticObject": "polarzui5statement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5statement",
									"url": sap.ui.require.toUrl("polar/zui5statement")
								}
							}
						}
					}
