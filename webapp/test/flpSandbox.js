		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5letter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5letter-display": {
								"semanticObject": "polarzui5letter",
								"action": "display",
								"description": "Carta de trabjo",
								"title": "Carta de trabajo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5letter",
									"url": sap.ui.require.toUrl("polar/zui5letter")
								}
							}
						}
					}
