		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5aprovacation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5aprovacation-display": {
								"semanticObject": "polarzui5aprovacation",
								"action": "display",
								"description": "Aprobación de vacaciones",
								"title": "Aprobación de vacaciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5aprovacation",
									"url": sap.ui.require.toUrl("polar/zui5aprovacation")
								}
							}
						}
					}
