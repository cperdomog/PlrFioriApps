		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5myvacareq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5myvacareq-display": {
								"semanticObject": "polarzui5myvacareq",
								"action": "display",
								"description": "Mis solicitudes de vacaciones",
								"title": "Mis solicitudes de vacaciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5myvacareq",
									"url": sap.ui.require.toUrl("polar/zui5myvacareq")
								}
							}
						}
					}
