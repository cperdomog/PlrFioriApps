		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#polarzui5libvaca-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"polarzui5libvaca-display": {
								"semanticObject": "polarzui5libvaca",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=polar.zui5libvaca",
									"url": sap.ui.require.toUrl("polar/zui5libvaca")
								}
							}
						}
					}
